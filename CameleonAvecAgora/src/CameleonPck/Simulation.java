...
public class Simulation{
    ...
    public static void main(String args[]){
        ...
        /**
         * creation de la Mail ou de l'Agora ou bien le lieu de mutation
         * 
         */
        Agora MonAgora = new Agora(camGraDisp);
        ...
        for(int i = 0 ; i < LesCouleurs.length; i++){
            LeCameleon[i] = new Cameleon(MonAgora,i+1, LesCouleurs[i], true);
        }
